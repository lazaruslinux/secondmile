...
export const MAX_MEDAL_SLOTS = 4
...
interface Props {
  ...
  // summary card on Home and the banner on You showing the same four.
  ids: string[]
  // Draw this many positions whether they are filled or not. The You screen
  // asks for all four, because an empty slot there is the invitation to fill
...
// sitting a little higher than the middle. The stars a medal has earned are
