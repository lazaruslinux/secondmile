...
| Interface icons | 17 | Tab bar, cheer, gear, pencil, play, eye, chest ladder marker, week diamond, running shoe, and the five sport marks | Chrome, everywhere |
...
Ninety-six files in total, all under `frontend/src/assets/`.
